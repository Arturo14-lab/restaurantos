...
function Dashboard({name='Arturo'}:{name?:string}) {
...
export default function App() {
  ...
  return <Shell onLogout={logout} access={access}><AppErrorBoundary><Suspense fallback={<ModuleLoading/>}><Routes>
    <Route path="/" element={guard('dashboard',<Dashboard name={access?.displayName}/>)}/>
